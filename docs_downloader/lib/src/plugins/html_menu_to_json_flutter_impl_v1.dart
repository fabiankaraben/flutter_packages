...
///
class HtmlMenuToJsonFlutterImplV1 implements HtmlMenuToJsonPlugin {
  ///
  @override
  ...
  String _convertLiToMd(Element element) {
    ...
    late String inner;
    if (anchorEl == null && element.classes.contains('nav-header')) {
      inner = '"title":"${element.text}", "path": "","type":"separator"';
